                ...
                'levels' => [
                    ...
                    $this->level(
                        ...
                        [
                            ...
                            $this->choice('Kamu ingin meminta air dengan sopan. Pilih kalimat yang tepat.', 'Can I have water, please?', ['Give water now!', 'Water me fast!', 'I water you!'], 'Kalimat ini sopan karena memakai "Can I have..." dan "please".', 'real_case', 'Baca situasi lalu pilih respons paling natural.'),
                        ],
                    ),
                ],
            ],
            [
                ...
                'levels' => [
                    ...
                    $this->level('level-3-simple-sentence', 'Level 3 - Kalimat Mandarin', 'Memahami kalimat Mandarin sangat sederhana.', 72, 28, [
                        ...
                        $this->choice('Seseorang berkata "谢谢". Respons sopan yang tepat adalah ...', '不客气', ['我是学生', '喝水', '老师'], '"不客气" berarti sama-sama.', 'real_case', 'Baca situasi lalu pilih respons paling natural.'),
                    ]),
                ],
            ],
            [
                ...
                'levels' => [
                    ...
                    $this->level('level-3-simple-sentence', 'Level 3 - Kalimat Korea', 'Memahami kalimat Korea pemula.', 72, 28, [
                        ...
                        $this->choice('Kamu bertemu guru. Sapaan yang paling sopan adalah ...', '안녕하세요', ['안녕', '밥', '책'], '"안녕하세요" lebih sopan untuk guru atau orang yang dihormati.', 'real_case', 'Baca situasi lalu pilih respons paling natural.'),
                    ]),
                ],
            ],
            [
                ...
                'levels' => [
                    ...
                    $this->level('level-3-simple-sentence', 'Level 3 - Kalimat Jepang', 'Memahami kalimat Jepang pemula.', 72, 28, [
                        ...
                        $this->choice('Seseorang berkata "ありがとう". Respons sopan yang tepat adalah ...', 'どういたしまして', ['学校', '水を飲みます', '学生'], '"どういたしまして" berarti sama-sama.', 'real_case', 'Baca situasi lalu pilih respons paling natural.'),
                    ]),
                ],
            ],
            [
                ...
                'levels' => [
                    ...
                    $this->level('level-3-simple-sentence', 'Level 3 - Kalimat Arab', 'Memahami kalimat Arab pemula.', 72, 28, [
                        ...
                        $this->choice('Seseorang berkata "شكرا". Respons sopan yang tepat adalah ...', 'عفوا', ['ماء', 'طالب', 'بيت'], '"عفوا" dapat digunakan sebagai sama-sama.', 'real_case', 'Baca situasi lalu pilih respons paling natural.'),
                    ]),
                ],
            ],
            [
                ...
                'levels' => [
                    ...
                    $this->level('level-3-simple-sentence', 'Level 3 - Kalimat Prancis', 'Memahami kalimat Prancis pemula.', 72, 28, [
                        ...
                        $this->choice('Seseorang berkata "Merci". Respons sopan yang tepat adalah ...', 'De rien', ['Ecole', 'Livre', 'Bonjour'], '"De rien" berarti sama-sama.', 'real_case', 'Baca situasi lalu pilih respons paling natural.'),
                    ]),
                ],
            ],
        ];
