...
class UserLearningProfilePolicy
{
    ...
    {
        return $user->can('view_any_user::learning::profile');
    }
    ...
    {
        return $user->can('view_user::learning::profile');
    }
    ...
    {
        return $user->can('create_user::learning::profile');
    }
    ...
    {
        return $user->can('update_user::learning::profile');
    }
    ...
    {
        return $user->can('delete_user::learning::profile');
    }
    ...
    {
        return $user->can('delete_any_user::learning::profile');
    }
     ...
     */
    public function replicate(User $user, UserLearningProfile $userLearningProfile): bool
    {
