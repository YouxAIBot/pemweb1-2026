        ...
        <div class="content-area">
            <section class="map-wrap">
                ...
                @forelse ($levels as $level)
                    ...
                    @endphp
                    <a href="{{ $locked ? '#' : route('learning.levels.show', [$part, $level]) }}"
                       class="level-node {{ $status }}"
                       ...
                       aria-label="{{ $level->title }}">
                        ...
                        <span class="level-tooltip">
                            ...
                            <p>{{ $locked ? 'Level ini masih terkunci.' : ($level->description ?: 'Klik untuk membuka latihan level ini.') }}</p>
                        </span>
                    </a>
                @empty
