...
<div class="premium-page">
    ...
    <main class="premium-shell">
        <section class="premium-head">
            ...
            <p>Pilih paket premium, transfer sesuai nominal, lalu kirim bukti pembayaran. Admin akan memverifikasi dan mengaktifkan premium tanpa mengubah data akun atau progress belajar.</p>
        </section>
